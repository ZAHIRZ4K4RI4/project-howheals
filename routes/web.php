...
Route::prefix('pelayanan')->group(function () {
    Route::get('/view', [PelayananController::class, 'PelayananView'])->name('backend.pelayanans.view');
    // Route::get('/add', [TPelayananController::class, 'PelayananAdd'])->name('backendss.pelayanan.add');
