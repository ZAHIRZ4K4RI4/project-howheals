...
<html lang="en">
  <head>
    ...
    <style>
      .gradient {
        background: linear-gradient(90deg, #5e5759 0%, #2f2e2b 100%);
      }
    </style>
  </head>
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full">Sepatu anda mengalami masalah?</p>
        ...
        <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_xlawpi2p.json"  background="transparent"  speed="1"  style="width: 300px; height: 300px;"  loop  autoplay></lottie-player>
        </lottie-player> 
      </div>
    </div>
